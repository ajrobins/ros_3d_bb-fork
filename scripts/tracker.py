...
class DetectedObject:
    ...
    def update(self, bounding_box):
        ...
        """
        x, y, z = bounding_box.x, bounding_box.y, bounding_box.z
        self.v_x = x - self.x
        self.v_y = y - self.y
        self.v_z = z - self.z
        self.x = x
...
class Tracker:
    ...
    def get_coordinates(self):
        ...
        for detected_object in self.objects:
            ...
            coordinates.append((detected_object.x, detected_object.y, detected_object.z))
    ...
    def update(self, bounding_boxes: list):
        ...
        # Otherwise, find the closest matches between existing objects and detections.
            ...
            distances = distance.cdist(
                ...
                [(bb.x, bb.y, bb.z) for bb in bounding_boxes],
                "euclidean",
            )
